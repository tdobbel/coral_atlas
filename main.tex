...
%        % state={},
    ...
    \begin{abstract}
        Coral populations have declined worldwide due to both global and local anthropogenic stressors, and almost all living coral cover could be lost under a warming of $>1.5$°C. Since avoiding climate change is no longer an option, local actions are needed to mitigate its impacts and support coral recovery through restoration and protection. To maximize the efficiency of these actions, biophysical models that can simulate the life history traits and transport patterns of coral larvae down to the reef scale are needed to estimate coral connectivity. However, due to the high computational cost of such models, connectivity studies often consider only a few coral species over a limited number of spawning events, thus lacking interannual and interspecific variability. Here, we used the multi-scale ocean model \slim to simulate larval dispersal of six key reef-building coral species in the Florida's Coral Reef over 10 consecutive years (2012-2021) with experimentally calibrated larval dynamics. Our results indicate that coral species with similar spawning windows tend to have similar connectivity networks. Furthermore, we highlighted reefs best suited for restoration by identifying top-performing reefs in terms of larval supply, export, and replenishment potential for all simulated years and species. Finally, we quantified the temporal and interspecific variability of different connectivity estimates across all modeled reefs. This study provides unprecedented easy-to-access reef-scale connectivity datasets to support future marine conservation strategies.
    \end{abstract}
...
As bio-physical models used to estimate reef connectivity typically require significant computational resources, most connectivity studies cover thus a limited number of spawning events and coral species. This undermines the robustness of the derived connectivity estimates, as they lack interannual and interspecific variability. In this study, we simulated the dispersal of larvae from six key reef-building coral species of Florida over 10 consecutive years (2012-2021). Using these 10 years of simulation, we identify consistent connectivity hotspots and strongly connected reef clusters for all simulated years and species. Furthermore, by identifying pairs of coral species with strongly correlated connectivity metrics, we highlight the potential for coupled management strategies.

% === METHODS ===

\section*{Methods}

in this study, we used a multidisciplinary approach. First, we experimentally estimated larval traits of six coral species. The calibrated larval traits were then used to simulate the potential larval connectivity during the mass spawning events of 10 consecutive years using a high-resolution biophysical models. The obtained connectivity networks were then analyzed using graph theory and statistical methods.
...
We estimated the similarity of the distribution of the connectivity metrics between species using the Pearson correlation coefficient following the methodology described in \citep{boccaletti2014structure}. The correlation was computed between all pairs of simulated species for each indicator of Table \ref{tab:indicators}. The obtained values range from -1 to 1, where 1 indicates a perfect positive correlation, 0 no correlation and -1 a perfect negative correlation.
...
Self-recruitment exhibited the largest interannual variability, with large values of quartile coefficients of dispersion on most reefs (Fig. \ref{fig:variability}). This is consistent with the absence of clear clusters of bottom-performers in terms of self-recruitment. Local retention varied significantly through time as well, except in the Marquesas, Biscayne, and North Palm Beach, where smaller quartile coefficients of dispersion were found. Most reefs showed limited interannual variability of weighted in- and out-degrees, except in the Dry Tortugas and Marquesas. Larger values of the quartile coefficient of dispersion were also found in North Palm Beach and the Lower Keys in the case of weighted out-degree.
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/species_averaged_quartile_coefficient_of_dispersion.png}
    \caption{\modif{Interannual variability of the species-averaged connectivity indicators as measure with the quartile coefficient of dispersion}. Weighted in- and out-degrees only exhibited significant interannual variability in some parts of FCR, while significant interannual variability in terms of local retention and self-recruitment was observed on most reefsi.
        \pdfcomment[color=yellow]{
            Key messages:\textCR
...
\emphc{Implications of our results for reef management:
    \begin{enumerate}
        \item Biophysical connectivity study relies on good quality experimental data and fine scale hydrodynamic simulations. Here we experimentally measured biological traits for 6 coral species and simulated 10 years of hydrodynamics capturing most of the interannual oceanic variability.
        \item We identified groups of species strongly correlated together that are hence good candidates for joint restoration efforts (e.g. \textit{P.~strigosa} and \textit{C.~natans}, or \textit{M.~cavernosa}, \textit{C.~natans} and \textit{O.~faveolata}).
        \item We further identified clusters of reefs that consistently acted as good sources and sinks for all species and all simulated years.
        \item Unlike self-recruitment and local retention, source and sink indicators exhibited limited interannual variability, hence confirming their utility to identify reefs with good potential for restoration or protection.
        \item The stability of the reef communities over time is quite variable between species. Some species have smaller communities showing less stability in their structure, which results in more local and shorter-term management actions.
    \end{enumerate}
}

% Summary of the results
Interannual variability of weighted in- and out-degrees for each reef, proxies for respectively source and sink reefs, is limited for most reefs which suggests management planning based on source/sink information will be effective. Local retention (a measure of self-persistence) and  self-recruitment (a measure of isolation) vary widely between years. Inter-species variability in connectivity patterns is less pronounced among species which spawn around the same time and have similar egg sizes, however several reefs were identified as good “sources” for all species, and thus constitute optimal sites for protection and/or restoration. Specifically, reefs with great restoration potential were found in the Dry Tortugas and norther Broward-Miami, and more marginally in the Middle Keys and North and South Palm Beach.
