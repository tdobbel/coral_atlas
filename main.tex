...
\emphc{Introductory paragraph: multidisciplinary approach combining experimental larval traits estimation, biophysical modeling and connectivity analysis with graph analysis and statistical methods.}
...
\emphc{Messages of Fig. \ref{fig:top10}:
\begin{itemize}
    \item Importance of the DT
    \item Hotspot of local retention quite spread out
    \item Beside DT, hotspots of in-degree at the end of FCR, and hotspots ou out-degree in the Middle Keys
\end{itemize}}
...
\emphc{Messages of Fig. \ref{fig:variability}:
\begin{itemize}
    \item In- and out-degrees are rather stable with the exception of the Dry Tortugas and Lower Keys (mostly on the outer shelf) for both indicators, and the nothermost part of the FCR for the weighted out-degree
    \begin{itemize}
         \item For variability of DT, mention retention of particles on the WFS in the discussion $\Rightarrow$ prevents long-distance dispersal of larvae from the DT (larval retention due to eddies observed in other papers)
    \end{itemize}
    \item Local retention and self-recruitment have much more spreadout interannual variability
\end{itemize}}
